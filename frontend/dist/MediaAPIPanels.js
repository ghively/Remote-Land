...
function StatusPill({
  ...
  const colors = {
    green: {
      ...
      shadow: '0 0 5px var(--color-success)'
    },
    yellow: {
      color: 'var(--color-warn)',
      shadow: '0 0 5px var(--color-warn)'
    },
    red: {
      color: 'var(--color-error)',
      shadow: '0 0 5px var(--color-error)'
    },
    cyan: {
      color: 'var(--neon-cyan)',
      shadow: 'var(--bloom-cyan)'
    },
    dim: {
      color: 'var(--text-dim)',
      shadow: 'none'
...
function ApiNotice({
  ...
  }, "[", service.toUpperCase(), "_API]"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '0.75rem',
      color: 'var(--text-dim)',
      textAlign: 'center',
  ...
  }, "> API KEY NOT CONFIGURED", /*#__PURE__*/React.createElement("br", null), "> RUNNING IN DEMO MODE"), /*#__PURE__*/React.createElement(Btn, {
    label: "[CONFIGURE API]",
    cls: "cyan",
    onClick: onConfigure
  }));
...
function BackendConfigPanel({
  ...
  const test = async () => {
    ...
    try {
      ...
      setTestResult({
        ok: true,
        msg: apiKey ? '> CONNECTION OK — KEY ACCEPTED' : '> BACKEND REACHABLE (no key — would enter demo mode)'
      });
    } catch (err) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "BACKEND_CONFIGURATION"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '0.72rem',
      color: 'var(--text-dim)',
      lineHeight: 1.8
    }
  }, "> Host of the NAS Terminal backend agent (port 3001).", /*#__PURE__*/React.createElement("br", null), "> API key matches `apiKey` in backend/config.json on the server.", /*#__PURE__*/React.createElement("br", null), "> Per-service keys (Radarr, Sonarr, Emby) live on the backend now.", /*#__PURE__*/React.createElement("br", null), "> Leave API key blank to switch to demo mode."), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "[BACKEND_AGENT]"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '0.7rem',
      color: 'var(--text-dim)',
      letterSpacing: 1,
  ...
  }, "HOST"), /*#__PURE__*/React.createElement("input", {
    ...
    style: {
      fontSize: '0.72rem',
      color: testResult.ok ? 'var(--neon-green)' : 'var(--color-error)',
      textShadow: testResult.ok ? 'var(--glow-green-sm)' : '0 0 4px var(--color-error)',
      letterSpacing: 1
    }
    ...
    onClick: test,
    disabled: testing
  }, testing ? '[ TESTING... ]' : '[ TEST_CONNECTION ]'), /*#__PURE__*/React.createElement("button", {
    className: "cmd-btn",
    style: {
      flex: 1,
      textAlign: 'center',
...
const MOCK_SAB_QUEUE = {
  queue: {
    ...
    slots: [{
      ...
      filename: 'Civil.War.2024.1080p.Bluray.x265',
      status: 'Downloading',
      mbleft: '4200.00',
      mb: '8400.00',
      timeleft: '0:04:12',
      ...
      filename: 'Furiosa.2024.2160p.UHD.BluRay',
      status: 'Queued',
      mbleft: '9100.00',
      mb: '9100.00',
      timeleft: '0:09:07',
      ...
      filename: 'Severance.S02E10.1080p.WEB',
      status: 'Downloading',
      mbleft: '1200.00',
      mb: '2400.00',
      timeleft: '0:01:12',
...
function MediaSummaryCard({
  ...
  }, "[", service.toUpperCase(), "_SUMMARY]"), /*#__PURE__*/React.createElement("span", {
    style: {
      flex: 1
    }
  }), isDemo && /*#__PURE__*/React.createElement(StatusPill, {
    text: "DEMO MODE",
    color: "dim"
  }), !isDemo && offline && /*#__PURE__*/React.createElement(StatusPill, {
    text: `${service.toUpperCase()} OFFLINE`,
    color: "red"
  }), !isDemo && !offline && data && /*#__PURE__*/React.createElement(StatusPill, {
    text: "ONLINE",
    color: "green"
  })), error && !offline && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '0.72rem',
      color: 'var(--color-warn)',
      textShadow: '0 0 4px var(--color-warn)'
    }
  }, "> ERR: ", error), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, "> [ DEEP DATA \u2014 REQUIRES BACKEND v2 ]", /*#__PURE__*/React.createElement("br", null), "> Full ", service, " lists (movies / episodes / queue items) are not exposed by the", /*#__PURE__*/React.createElement("br", null), "> current backend. Use the upstream web UI for full management."), onOpenWebUI && /*#__PURE__*/React.createElement("button", {
    className: "cmd-btn",
    style: {
      width: '100%',
      textAlign: 'center',
...
// ══════════════════════════════════════════════════════════════════════════════
function RadarrPanel({
  onOpenWebUI
}) {
  const ctx = window.useBackend ? window.useBackend() : {
    api: null
  };
  const fetcher = useCallback(() => ctx.api ? ctx.api.radarr() : Promise.resolve({
    status: 'offline'
  }), [ctx.api]);
  return /*#__PURE__*/React.createElement(MediaSummaryCard, {
    service: "Radarr",
...
// ══════════════════════════════════════════════════════════════════════════════
function SonarrPanel({
  onOpenWebUI
}) {
  const ctx = window.useBackend ? window.useBackend() : {
    api: null
  };
  const fetcher = useCallback(() => ctx.api ? ctx.api.sonarr() : Promise.resolve({
    status: 'offline'
  }), [ctx.api]);
  return /*#__PURE__*/React.createElement(MediaSummaryCard, {
    service: "Sonarr",
...
function SABnzbdPanel({
  ...
  const doDelete = async nzo_id => {
    try {
      ...
      setQueueData(q => q ? {
        ...q,
        slots: q.slots.filter(s => s.nzo_id !== nzo_id)
      } : q);
    } catch {}
  };
  const fmt = mbStr => {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "[SABNZBD]"), ['queue', 'history'].map(t => /*#__PURE__*/React.createElement(Btn, {
    key: t,
    label: `[${t.toUpperCase()}]`,
    cls: tab === t ? 'cyan' : '',
    onClick: () => setTab(t)
  ...
  }), error && /*#__PURE__*/React.createElement(StatusPill, {
    text: "API ERR \u2014 DEMO",
    color: "yellow"
  }), !hasKey && /*#__PURE__*/React.createElement(StatusPill, {
    text: "DEMO MODE",
    color: "dim"
  ...
  })), tab === 'queue' && queueData && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '8px 12px',
    ...
    style: {
      color: paused ? 'var(--color-warn)' : 'var(--neon-green)',
      textShadow: paused ? '0 0 5px var(--color-warn)' : 'var(--glow-green-sm)'
    }
  }, "STATUS: ", paused ? 'PAUSED' : queueData.status?.toUpperCase()), /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--neon-cyan)',
      textShadow: 'var(--bloom-cyan)'
    }
  ...
  }, fmt(queueData.mbleft), " LEFT | ETA: ", queueData.timeleft)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 8
  ...
  }, totalPct.toFixed(0), "%"))), tab === 'queue' && /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      overflowY: 'auto',
      padding: 10,
  ...
  }, loading && !queueData ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 20,
      color: 'var(--text-dim)',
      fontSize: '0.8rem'
    }
  }, "> LOADING QUEUE...") : !queueData?.slots?.length ? /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 20,
      color: 'var(--text-dim)',
      fontSize: '0.8rem'
    }
  }, "> QUEUE IS EMPTY") : queueData.slots.map((slot, i) => {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, /*#__PURE__*/React.createElement("span", null, "AGE: ", slot.avg_age), /*#__PURE__*/React.createElement("span", null, "ETA: ", slot.timeleft), /*#__PURE__*/React.createElement("span", null, fmt(slot.mbleft), " left"))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 4,
        flexShrink: 0
      ...
      text: slot.status?.toUpperCase(),
      color: slot.status === 'Downloading' ? 'cyan' : 'yellow'
    }), /*#__PURE__*/React.createElement(Btn, {
      label: "[DEL]",
      cls: "danger",
    ...
    }, "[", item.category?.toUpperCase(), "]"), /*#__PURE__*/React.createElement("span", null, item.size))), /*#__PURE__*/React.createElement(StatusPill, {
